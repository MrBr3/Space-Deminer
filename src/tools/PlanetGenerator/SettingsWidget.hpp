...
public:
  ...
  Gtk::Widget& append_gradient_widget(const Glib::ustring& name, const Glib::ustring& label, const Glib::ustring& tooltip, const std::vector<Glib::ustring>& items, const sigc::slot<Gradient>& getter, const sigc::slot<void, const Gradient&>& setter, sigc::signal<void>& signal_changed)
  {
    return append_gradient_widget(table, n_entries, name, label, tooltip, getter, setter, signal_changed);
  }
  ...
  static Gtk::Widget& append_gradient_widget(Gtk::Table& table, guint& n_entries, const Glib::ustring& name, const Glib::ustring& label, const Glib::ustring& tooltip, const sigc::slot<Gradient>& getter, const sigc::slot<void, const Gradient&>& setter, sigc::signal<void>& signal_changed);
public:
