...
MainWindow::MainWindow()
{
  ...
  _menu_bar.append(menu_view);
    ...
    signal_sensitive_for_changes_changed().connect(SettingsWidget::create_updater<bool, bool>(sigc::mem_fun(*this, &MainWindow::get_sensitive_for_changes), sigc::mem_fun(menu_view, &MyMenuItem::set_sensitive)));
      ...
      menu_view_menu.append(menu_view_sep1);
      ...
      menu_view_menu.append(menu_view_lights);
        menu_view_lights.set_accel_key("l");
        menu_view_lights.set_label(_("Draw _Lights"));
        menu_view_lights.set_use_underline();
        menu_view_lights.set_active(view_3d->get_draw_light_representation());
        menu_view_lights.signal_toggled().connect(sigc::mem_fun(*this, &MainWindow::draw_lights_toggled));
        view_3d->signal_draw_light_representation_changed().connect(sigc::mem_fun(menu_view_lights, &MyCheckMenuItem::set_active));
