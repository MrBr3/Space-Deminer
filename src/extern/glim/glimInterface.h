...
namespace NS_GLIM
{
	...
	*/
	...
	public:
		...
		virtual void Attribute1f (const char* szAttribute, float a1) = 0;
		//! Specifies a new value for the attribute with the given name.
		virtual void Attribute2f (const char* szAttribute, float a1, float a2) = 0;
		//! Specifies a new value for the attribute with the given name.
		virtual void Attribute3f (const char* szAttribute, float a1, float a2, float a3) = 0;
		//! Specifies a new value for the attribute with the given name.
		virtual void Attribute4f (const char* szAttribute, float a1, float a2, float a3, float a4) = 0;

		//! Specifies a new value for the attribute with the given name.
		virtual void Attribute1i (const char* szAttribute, int a1) = 0;
		//! Specifies a new value for the attribute with the given name.
		virtual void Attribute2i (const char* szAttribute, int a1, int a2) = 0;
		//! Specifies a new value for the attribute with the given name.
		virtual void Attribute3i (const char* szAttribute, int a1, int a2, int a3) = 0;
		//! Specifies a new value for the attribute with the given name.
		virtual void Attribute4i (const char* szAttribute, int a1, int a2, int a3, int a4) = 0;

		//! Specifies a new value for the attribute with the given name.
		virtual void Attribute4ub (const char* szAttribute, unsigned char a1, unsigned char a2, unsigned char a3, unsigned char a4 = 255) = 0;
