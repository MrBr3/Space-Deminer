...
namespace NS_GLIM
{
	void GLIM_BATCH::Attribute1f (const char* szAttribute, float a1)
	{
	...
	void GLIM_BATCH::Attribute2f (const char* szAttribute, float a1, float a2)
	{
		GlimArrayData& Data = m_Data.m_Attributes[szAttribute];
		Data.m_CurrentValue[0].Float = a1;
	...
	void GLIM_BATCH::Attribute3f (const char* szAttribute, float a1, float a2, float a3)
	{
		GlimArrayData& Data = m_Data.m_Attributes[szAttribute];
		Data.m_CurrentValue[0].Float = a1;
		Data.m_CurrentValue[1].Float = a2;
	...
	void GLIM_BATCH::Attribute4f (const char* szAttribute, float a1, float a2, float a3, float a4)
	{
		GlimArrayData& Data = m_Data.m_Attributes[szAttribute];
		Data.m_CurrentValue[0].Float = a1;
		Data.m_CurrentValue[1].Float = a2;
	...
	void GLIM_BATCH::Attribute1i (const char* szAttribute, int a1)
	{
		GlimArrayData& Data = m_Data.m_Attributes[szAttribute];
	...
	void GLIM_BATCH::Attribute2i (const char* szAttribute, int a1, int a2)
	{
		GlimArrayData& Data = m_Data.m_Attributes[szAttribute];
		Data.m_CurrentValue[0].Int = a1;
	...
	void GLIM_BATCH::Attribute3i (const char* szAttribute, int a1, int a2, int a3)
	{
		GlimArrayData& Data = m_Data.m_Attributes[szAttribute];
		Data.m_CurrentValue[0].Int = a1;
		Data.m_CurrentValue[1].Int = a2;
	...
	void GLIM_BATCH::Attribute4i (const char* szAttribute, int a1, int a2, int a3, int a4)
	{
		GlimArrayData& Data = m_Data.m_Attributes[szAttribute];
		Data.m_CurrentValue[0].Int = a1;
		Data.m_CurrentValue[1].Int = a2;
	...
	void GLIM_BATCH::Attribute4ub (const char* szAttribute, unsigned char a1, unsigned char a2, unsigned char a3, unsigned char a4)
	{
		GlimArrayData& Data = m_Data.m_Attributes[szAttribute];
